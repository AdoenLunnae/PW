	    ...
	    <div class="contenedor-cabecera">
	        <div class="w-1/4">
	            <div class="absolute -mt-24 ml-20 mr-6">
	            	<img src="/pw/img/perfil.png" alt="logo" onclick="abrirPopUp('overlay13', 'popup13')" class="imagen-perfil"/>
	            </div>
	        </div>
	...
	<div class="container mx-auto flex flex-row mt-3 text-sm leading-normal">
	    ...
	    <div class="w-full lg:w-1/4 lg:pl-0 pr-6 mr-6 mt-8 mb-4">
	        ...
	        <div class="caja">
	            ...
	            <div class="accion-caja"><a href="resultados.html"
	                                        class="enlace-pu">Ver más</a></div>
	        </div>
	    </div>
	    ...
	    <div class="w-full lg:w-1/2 mb-4">
	        ...
	        <div class="caja">
	            ...
	            <div class="accion-caja"><a href="#"
	                                        class="enlace-pu"
	                                        onclick="abrirPopUp('overlay', 'popup')">Editar</a>
	            </div>
	        </div>
